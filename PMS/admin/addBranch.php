...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($location) && !empty($contact_number) && !empty($address)) {
        $stmt = $conn->prepare("INSERT INTO branches (location, contact_number, address) VALUES (?, ?, ?)");
        $stmt->bind_param("sss", $location, $contact_number, $address);
    ...
    <div class="flex flex-1">
        ...
        <main class="flex-1 flex flex-col">
            ...
            <div class="p-6 flex-1">
                <h1 class="text-2xl font-bold text-primary-700 mb-6">Add New Branch</h1>
                ...
                <form method="POST" class="bg-white p-6 rounded-lg shadow-lg">
                    <div class="mb-4">
                        <label class="block text-gray-700 font-bold mb-2">Branch Location</label>
                    ...
                    <div class="mb-4">
    <button type="submit" class="bg-green-500 text-white px-4 py-2 rounded-lg">Add Branch</button>
</div>
